 ...
 * Put function defs in Functions.h. Put implementation here.
 */
...
SDL_Surface* init(int screenWidth,int screenHeight,int screenBPP) {
    ...
    //Set up the screen
    SDL_Surface* screen = SDL_SetVideoMode(screenWidth,screenHeight,screenBPP,SDL_SWSURFACE | SDL_DOUBLEBUF);
